...
class AlumnoProfesor:  public profesor,  public  Alumno {
    protected:
        int numpermiso;
    public: 
        AlumnoProfesor()
...
void AlumnoProfesor::setPermiso(int n)
{
    if (n>0)
    {
        numpermiso = n;
    }else{
        cout<<"el numero tiene que ser valido"<<endl;
    }
}
int AlumnoProfesor::getPermiso()
{
    return numpermiso;
}
int main()
{
    ...
    Al.Alumno::setNombre((char *)"PEPE");
    Al.Alumno::setEdad(15);
    Al.setSueldo(1500);
